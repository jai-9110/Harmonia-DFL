...
func newEdgeOperator( 
	...
	trainPlanRepoGitHttpURL string,
	aggregatedModelRepoGitHttpURL string,
	edgeModelRepoGitHttpURLs []string, // edgeModelRepoGitHttpURL string 改成 edgeModelRepoGitHttpURLs []string
	trainFinish func(),
) *Operator {
	return &Operator {
		edge.InitState,
		...
		edge.Payload {
			...
			TrainPlanRepoGitHttpURL: trainPlanRepoGitHttpURL,
			AggregatedModelRepoGitHttpURL: aggregatedModelRepoGitHttpURL,
			EdgeModelRepoGitHttpURLs: edgeModelRepoGitHttpURLs, // edgeModelRepoGitHttpURL 改成 edgeModelRepoGitHttpURLs
		},
		&sync.Mutex{},
		trainFinish,
	}
